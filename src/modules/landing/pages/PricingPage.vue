<template>
  <div class="flex justify-center items-center">
    <div class="">
      <div class="text-center font-semibold mt-7 mb-4">
        <h1 class="text-5xl">
      ...
      <div class="pt-13 flex flex-row mb-20">
        <!-- Basic Card -->
        <div class="w-96 p-8 bg-white text-center rounded-3xl pr-16 shadow-xl">
          ...
          <div class="pt-8">
            ...
            <a href="#" class="">
              <p class="w-full py-4 bg-blue-600 mt-8 rounded-xl text-white hover:bg-blue-700">
